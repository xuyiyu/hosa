...
package com.hosa.web.web.action.user;
...
public class UserAction extends WebActionSupport {
	...
	public String list() throws Exception {
		try {
			...
			responseSuccessJson(page, "common.list.success");
	...
	public String delete() throws Exception {
		try {
			...
			responseSuccessJson(checkedIdList,"common.delete.success");			
		} catch(ServiceException ex) {
	...
	public String add() throws Exception {
		try {			
			...
			responseSuccessJson(user,"common.add.success");			
		} catch(ServiceException ex) {
			log.warn("save fail.", ex);
			responseServiceErrorJson(getCommonSaveErrorInfo("user.label.user", ex.getErrorCode()));
		} catch(Exception e) {
	...
	public String edit() throws Exception {
		try {			
			...
			responseSuccessJson(user,"common.edit.success");			
		} catch(ServiceException ex) {
			log.warn("save fail.", ex);
			responseServiceErrorJson(getCommonSaveErrorInfo("user.label.user", ex.getErrorCode()));
		} catch(Exception e) {
	...
	public String input() throws Exception {
		try {
			...
			responseSuccessJson(user,"common.input.success");			
		} catch(ServiceException ex) {
