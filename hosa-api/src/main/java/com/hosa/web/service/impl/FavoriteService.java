...
public class FavoriteService extends BaseService implements IFavoriteService {
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#findPage(com.lps.db.base.page.Page, com.lps.db.vo.query.FavoriteQuery)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#deleteByMultipleId(java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#deleteById(java.lang.Long)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#saveOrUpdate(com.lps.db.model.Favorite)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#save(com.lps.db.model.Favorite)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#update(com.lps.db.model.Favorite)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#getById(java.lang.Long)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#getByMultipleId(java.util.List)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#getByIdFromCache(java.lang.Long)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#findList(com.lps.db.vo.query.FavoriteQuery)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#findList(com.lps.db.vo.query.FavoriteQuery, int)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#findList(com.lps.db.vo.query.FavoriteQuery, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@Transactional(propagation=Propagation.NOT_SUPPORTED)
	...
	/*
	 * (non-Javadoc)
	 * @see com.hosa.web.service.IFavoriteService#findAllList()
	 */
