...
package ${basepackage}${projectpackage}.model;
...
import ${basepackage}.core.utils.DateConvertUtils;
...
public class ${className} extends BaseEntity implements java.io.Serializable{
	...
	<#list table.columns as column>
	<#if column.isDateTimeColumn && column == "modified">
	public static final String FORMAT_${column.constantName} = TIMESTAMP_FORMAT;
	</#if>
	</#list>
