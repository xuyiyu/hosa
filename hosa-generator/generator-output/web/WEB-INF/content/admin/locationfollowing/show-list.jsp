...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> LocationFollowing<s:text name="common.label.management"/><span>>
						LocationFollowing<s:text name="common.label.management"/> </span>
				</h1>
			</div>
					...
					<div>
						<div class=" jarviswidget jarviswidget-color-blueDark">
							...
							<header>
								...
								<h2>LocationFollowing<s:text name="common.label.info"/></h2>
							</header>
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="location_id">locationId</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													...
													item-view><label class="filter_locationId" item-id="locationId"> &nbsp;</label></td>
												...
												<td>
													<div class="btn-group  btn-group-justified">
														<shiro:hasAnyRoles name="auth-locationfollowing-edit">
															<a href="javascript:void(0);"
																class="btn btn-primary btn-xs " item-id="button-modify">
																<s:text name="common.label.edit"/> </a>
														</shiro:hasAnyRoles>
														<shiro:hasAnyRoles name="auth-locationfollowing-delete">
															<a href="javascript:void(0);"
										...
										<div class="row" style="margin-top: auto;">
											<div class="col-sm-6">
												<div class="pull-left">
													...
													<shiro:hasAnyRoles name="auth-locationfollowing-add">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.setting"/>LocationFollowing<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="edit-form" class="smart-form">
								...
								<header> LocationFollowing<s:text name="common.label.info"/> </header>
								<fieldset>
									<section>
										<label class="input"> <i
											...
											id="locationId"
											name="locationId" /> <b
											class="tooltip tooltip-top-right"><s:text name="common.label.input"/>locationId</b>
										</label>
									</section>
									<section>
										<label class="input"> <i
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">LocationFollowing<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
								...
								<fieldset>
									<div class="row">
										...
										<section class="col col-9">
											<label class="" item-id="locationId">
											</label>
										</section>
									</div>
									<div class="row">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.search"/>LocationFollowing<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script
		src="${ctx}/webadmin/js/pages/locationfollowing/locationfollowing.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
