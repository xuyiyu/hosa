...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> UserFavoriteRelation<s:text name="common.label.management"/><span>>
						UserFavoriteRelation<s:text name="common.label.management"/> </span>
				</h1>
			</div>
					...
					<div>
						<div class=" jarviswidget jarviswidget-color-blueDark">
							...
							<header>
								...
								<h2>UserFavoriteRelation<s:text name="common.label.info"/></h2>
							</header>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="favorite_id">favoriteId</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													class="col-xs-4 col-sm-4 col-md-2 col-lg-2  view"
													item-view><label class="filter_favoriteId" item-id="favoriteId"> &nbsp;</label></td>
												...
												<td>
													<div class="btn-group  btn-group-justified">
														<shiro:hasAnyRoles name="auth-userfavoriterelation-edit">
															<a href="javascript:void(0);"
																class="btn btn-primary btn-xs " item-id="button-modify">
																<s:text name="common.label.edit"/> </a>
														</shiro:hasAnyRoles>
														<shiro:hasAnyRoles name="auth-userfavoriterelation-delete">
															<a href="javascript:void(0);"
										...
										<div class="row" style="margin-top: auto;">
											<div class="col-sm-6">
												<div class="pull-left">
													...
													<shiro:hasAnyRoles name="auth-userfavoriterelation-add">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.setting"/>UserFavoriteRelation<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="edit-form" class="smart-form">
								...
								<header> UserFavoriteRelation<s:text name="common.label.info"/> </header>
								<fieldset>
									<section>
										<label class="input"> <i
									...
									<section>
										<label class="input"> <i
											...
											id="favoriteId"
											name="favoriteId" /> <b
											class="tooltip tooltip-top-right"><s:text name="common.label.input"/>favoriteId</b>
										</label>
									</section>
									<section>
										<label class="input"> <i
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">UserFavoriteRelation<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="view-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										<section class="col col-3">
											<label class="label">favoriteId:</label>
										</section>
										<section class="col col-9">
											<label class="" item-id="favoriteId">
											</label>
										</section>
									</div>
									<div class="row">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.search"/>UserFavoriteRelation<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script
		src="${ctx}/webadmin/js/pages/userfavoriterelation/userfavoriterelation.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
