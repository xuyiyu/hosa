...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> Favorite<s:text name="common.label.management"/><span>>
						Favorite<s:text name="common.label.management"/> </span>
				</h1>
			</div>
					...
					<div>
						<div class=" jarviswidget jarviswidget-color-blueDark">
							...
							<header>
								...
								<h2>Favorite<s:text name="common.label.info"/></h2>
							</header>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="favorite_cnt">favoriteCnt</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													class="col-xs-4 col-sm-4 col-md-2 col-lg-2  view"
													item-view><label class="filter_favoriteCnt" item-id="favoriteCnt"> &nbsp;</label></td>
										...
										<div class="row" style="margin-top: auto;">
											<div class="col-sm-6">
												<div class="pull-left">
													...
													<shiro:hasAnyRoles name="auth-favorite-add">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.setting"/>Favorite<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="edit-form" class="smart-form">
								...
								<header> Favorite<s:text name="common.label.info"/> </header>
								<fieldset>
									<section>
										<label class="input"> <i
									...
									<section>
										<label class="input"> <i
											class="icon-append fa fa-question-circle"></i> <input
											type="text" class="form-control"
											placeholder="favoriteCnt"
											id="favoriteCnt"
											name="favoriteCnt" /> <b
											class="tooltip tooltip-top-right"><s:text name="common.label.input"/>favoriteCnt</b>
										</label>
									</section>
									<section>
										<label class="input"> <i
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">Favorite<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="view-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										<section class="col col-3">
											<label class="label">favoriteCnt:</label>
										</section>
										<section class="col col-9">
											<label class="" item-id="favoriteCnt">
											</label>
										</section>
									</div>
									<div class="row">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel"><s:text name="common.label.search"/>Favorite<s:text name="common.label.info"/></h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script
		src="${ctx}/webadmin/js/pages/favorite/favorite.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
