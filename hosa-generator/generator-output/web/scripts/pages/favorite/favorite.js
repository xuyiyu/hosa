$(function() {
	...
	var queryUrl = ctx + "/webadmin/favorite/favorite/list.htm";
	var getUrl = ctx + "/webadmin/favorite/favorite/input.htm";
	var addSaveUrl = ctx + "/webadmin/favorite/favorite/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/favorite/favorite/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/favorite/favorite/delete/save.htm";
	
	var favoriteMap = new HashMap();
	...
	var columns = [  "id" ,  "name" ,  "favoriteCnt" ,  "createdAt"];	
	var searchColumns = [  "name" ,  "favoriteCnt" ,  "createdAt"];
	var filterColumns = [  "filter_name" ,  "filter_favoriteCnt" ,  "filter_createdAt"];
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = favoriteMap.get(itemId);
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["favoriteQuery."+o+""] = val;
			} else {
				param["favoriteQuery."+o+""] = "";
			}
		});
