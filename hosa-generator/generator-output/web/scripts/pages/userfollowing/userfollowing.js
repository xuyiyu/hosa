$(function() {
	...
	var queryUrl = ctx + "/webadmin/userfollowing/userfollowing/list.htm";
	var getUrl = ctx + "/webadmin/userfollowing/userfollowing/input.htm";
	var addSaveUrl = ctx + "/webadmin/userfollowing/userfollowing/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/userfollowing/userfollowing/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/userfollowing/userfollowing/delete/save.htm";
	
	var userfollowingMap = new HashMap();
	...
	var columns = [  "id" ,  "userId" ,  "followerUserId" ,  "createdAt"];	
	var searchColumns = [  "userId" ,  "followerUserId" ,  "createdAt"];
	var filterColumns = [  "filter_userId" ,  "filter_followerUserId" ,  "filter_createdAt"];
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = userfollowingMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["userFollowing."+o+""] = val;
			} else {
				param["userFollowing."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["userFollowingQuery."+o+""] = val;
			} else {
				param["userFollowingQuery."+o+""] = "";
			}
		});
