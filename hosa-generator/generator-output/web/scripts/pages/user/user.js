$(function() {
	...
	var queryUrl = ctx + "/webadmin/user/user/list.htm";
	var getUrl = ctx + "/webadmin/user/user/input.htm";
	var addSaveUrl = ctx + "/webadmin/user/user/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/user/user/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/user/user/delete/save.htm";
	...
	var columns = [  "id" ,  "nick" ,  "portraitUrl" ,  "follower" ,  "userFollowing" ,  "locationFollowing" ,  "briefDescription" ,  "imageCnt" ,  "praisingCnt" ,  "praisedCnt" ,  "notifiyCnt" ,  "createdAt"];	
	var searchColumns = [  "nick" ,  "portraitUrl" ,  "follower" ,  "userFollowing" ,  "locationFollowing" ,  "briefDescription" ,  "imageCnt" ,  "praisingCnt" ,  "praisedCnt" ,  "notifiyCnt" ,  "createdAt"];
	var filterColumns = [  "filter_nick" ,  "filter_portraitUrl" ,  "filter_follower" ,  "filter_userFollowing" ,  "filter_locationFollowing" ,  "filter_briefDescription" ,  "filter_imageCnt" ,  "filter_praisingCnt" ,  "filter_praisedCnt" ,  "filter_notifiyCnt" ,  "filter_createdAt"];
