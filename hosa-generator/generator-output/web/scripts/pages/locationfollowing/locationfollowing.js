$(function() {
	...
	var queryUrl = ctx + "/webadmin/locationfollowing/locationfollowing/list.htm";
	var getUrl = ctx + "/webadmin/locationfollowing/locationfollowing/input.htm";
	var addSaveUrl = ctx + "/webadmin/locationfollowing/locationfollowing/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/locationfollowing/locationfollowing/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/locationfollowing/locationfollowing/delete/save.htm";
	
	var locationfollowingMap = new HashMap();
	...
	var columns = [  "id" ,  "locationId" ,  "followerUserId" ,  "createdAt"];	
	var searchColumns = [  "locationId" ,  "followerUserId" ,  "createdAt"];
	var filterColumns = [  "filter_locationId" ,  "filter_followerUserId" ,  "filter_createdAt"];
	...
	var loadList = function(p) {	
		...
		$.webAjax(queryUrl, param, function(responseData) {		
			...
			if(responseData.r_code == 0) {
				...
				if(data) {
					locationfollowingMap = new HashMap();
					$.each(data.result, function(i, o){
						locationfollowingMap.put(o.id, o);
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = locationfollowingMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["locationFollowing."+o+""] = val;
			} else {
				param["locationFollowing."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["locationFollowingQuery."+o+""] = val;
			} else {
				param["locationFollowingQuery."+o+""] = "";
			}
		});
