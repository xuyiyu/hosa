$(function() {
	...
	var queryUrl = ctx + "/webadmin/image/image/list.htm";
	var getUrl = ctx + "/webadmin/image/image/input.htm";
	var addSaveUrl = ctx + "/webadmin/image/image/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/image/image/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/image/image/delete/save.htm";
	...
	var columns = [  "id" ,  "bitmapWidth" ,  "bitmapHeight" ,  "originalUrl" ,  "compressUrl" ,  "locationName" ,  "longitude" ,  "latitude" ,  "content" ,  "userId" ,  "favoritedCnt" ,  "commentCnt" ,  "createdAt"];	
	var searchColumns = [  "bitmapWidth" ,  "bitmapHeight" ,  "originalUrl" ,  "compressUrl" ,  "locationName" ,  "longitude" ,  "latitude" ,  "content" ,  "userId" ,  "favoritedCnt" ,  "commentCnt" ,  "createdAt"];
	var filterColumns = [  "filter_bitmapWidth" ,  "filter_bitmapHeight" ,  "filter_originalUrl" ,  "filter_compressUrl" ,  "filter_locationName" ,  "filter_longitude" ,  "filter_latitude" ,  "filter_content" ,  "filter_userId" ,  "filter_favoritedCnt" ,  "filter_commentCnt" ,  "filter_createdAt"];
