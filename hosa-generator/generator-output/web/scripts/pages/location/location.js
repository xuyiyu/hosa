$(function() {
	...
	var queryUrl = ctx + "/webadmin/location/location/list.htm";
	var getUrl = ctx + "/webadmin/location/location/input.htm";
	var addSaveUrl = ctx + "/webadmin/location/location/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/location/location/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/location/location/delete/save.htm";
	...
	var columns = [  "id" ,  "name" ,  "type" ,  "follower" ,  "imageCnt" ,  "favoritedCnt" ,  "createdAt"];	
	var searchColumns = [  "name" ,  "type" ,  "follower" ,  "imageCnt" ,  "favoritedCnt" ,  "createdAt"];
	var filterColumns = [  "filter_name" ,  "filter_type" ,  "filter_follower" ,  "filter_imageCnt" ,  "filter_favoritedCnt" ,  "filter_createdAt"];
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = locationMap.get(itemId);
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["locationQuery."+o+""] = val;
			} else {
				param["locationQuery."+o+""] = "";
			}
		});
