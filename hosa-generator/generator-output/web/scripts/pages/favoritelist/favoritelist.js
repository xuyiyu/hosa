$(function() {
	...
	var queryUrl = ctx + "/webadmin/favoritelist/favoritelist/list.htm";
	var getUrl = ctx + "/webadmin/favoritelist/favoritelist/input.htm";
	var addSaveUrl = ctx + "/webadmin/favoritelist/favoritelist/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/favoritelist/favoritelist/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/favoritelist/favoritelist/delete/save.htm";
	
	var favoritelistMap = new HashMap();
	...
	var columns = [  "id" ,  "favoriteListId" ,  "imageId" ,  "createdAt"];	
	var searchColumns = [  "favoriteListId" ,  "imageId" ,  "createdAt"];
	var filterColumns = [  "filter_favoriteListId" ,  "filter_imageId" ,  "filter_createdAt"];
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = favoritelistMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["favoriteList."+o+""] = val;
			} else {
				param["favoriteList."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["favoriteListQuery."+o+""] = val;
			} else {
				param["favoriteListQuery."+o+""] = "";
			}
		});
