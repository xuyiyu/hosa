$(function() {
	...
	var queryUrl = ctx + "/webadmin/userfavoriterelation/userfavoriterelation/list.htm";
	var getUrl = ctx + "/webadmin/userfavoriterelation/userfavoriterelation/input.htm";
	var addSaveUrl = ctx + "/webadmin/userfavoriterelation/userfavoriterelation/add/save.htm";
	var editSaveUrl = ctx + "/webadmin/userfavoriterelation/userfavoriterelation/edit/save.htm";
	var deleteUrl = ctx + "/webadmin/userfavoriterelation/userfavoriterelation/delete/save.htm";
	
	var userfavoriterelationMap = new HashMap();
	...
	var columns = [  "id" ,  "userId" ,  "favoriteId" ,  "createdAt"];	
	var searchColumns = [  "userId" ,  "favoriteId" ,  "createdAt"];
	var filterColumns = [  "filter_userId" ,  "filter_favoriteId" ,  "filter_createdAt"];
	...
	var loadList = function(p) {	
		...
		$.webAjax(queryUrl, param, function(responseData) {		
			...
			if(responseData.r_code == 0) {
				...
				if(data) {
					userfavoriterelationMap = new HashMap();
					$.each(data.result, function(i, o){
						userfavoriterelationMap.put(o.id, o);
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var item = userfavoriterelationMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["userFavoriteRelation."+o+""] = val;
			} else {
				param["userFavoriteRelation."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["userFavoriteRelationQuery."+o+""] = val;
			} else {
				param["userFavoriteRelationQuery."+o+""] = "";
			}
		});
