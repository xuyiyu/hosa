...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 业务管理<span>> 车系管理 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="brandType">品牌类型</th>
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="seriesName">系列名称</th>
													
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="recommend">是否推荐</th>
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="recommendTimeString">推荐时间</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td class="col-xs-4 col-sm-4 col-md-2 col-lg-2 filter_brandType view"
													item-id="brandType" item-view>&nbsp;</td>
												<td class="col-xs-4 col-sm-4 col-md-2 col-lg-2 filter_seriesName view"
													item-id="seriesName" item-view>&nbsp;</td>
												<td class="col-xs-4 col-sm-4 col-md-2 col-lg-2 filter_recommend view"
													item-id="recommend" item-view>&nbsp;</td>
												<td class="col-xs-4 col-sm-4 col-md-2 col-lg-2 filter_recommendTime view"
													item-id="recommendTimeString" item-view>&nbsp;</td>
												<td>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">设置车系信息</h4>
					</div>
								...
								<fieldset>
									...
									<section>
										<label class="input"> <i
											...
											type="text" class="form-control" placeholder="系列名称"
											id="seriesName" name="seriesName" /> <b
											class="tooltip tooltip-top-right">需要输入系列名称</b>
										</label>
									</section>
									...
									<section>
										...
										<select style="width:100%"
											class="select2" id="brandType" name="brandType">
												<option></option>
									...
									<section>
										<label class="input"> <i
											class="icon-append fa fa-question-circle"></i> <input
											type="text" class="form-control" placeholder="图片外链"
											id="picLink" name="picLink" /> <b
											class="tooltip tooltip-top-right">需要输入列表图标外链</b>
										</label>
									</section>
									<section>
										<label class="input"> <i
											class="icon-append fa fa-question-circle"></i> <input
											type="text" class="form-control" placeholder="背景图外链"
											id="bgLink" name="bgLink" /> <b
											class="tooltip tooltip-top-right">需要输入背景图外链</b>
										</label>
									</section>
									...
									<section>
										<section class="col col-3">
											<label class="label">是否推荐:</label>
										</section>
										<section class="col col-9">
										<div class="inline-group">
										<label class="radio">
										<input type="radio" name="recommendRadio" value="1">
										<i></i>是</label>
										<label class="radio">
											<input type="radio" name="recommendRadio" value="0">
											<i></i>否</label>
											</div>
										</section>		
									</section>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">车系信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="view-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										<section class="col col-3">
											<label class="label">品牌类型{1:奔驰}:</label>
										</section>
										<section class="col col-9">
											<label class="" item-id="brandType"> </label>
										</section>
									</div>
									<div class="row">
										<section class="col col-3">
										...
										<section class="col col-9">
											<label class="" item-id="seriesName"> </label>
										</section>
									</div>
									<div class="row">
										<section class="col col-3">
									...
									<div class="row">
										<section class="col col-3">
											<label class="label">图片外链:</label>
										</section>
										<section class="col col-9">
											<label class="" item-id="picLink"> </label>
										</section>
									</div>
									<div class="row">
										<section class="col col-3">
											<label class="label">背景图URL:</label>
										</section>
										<section class="col col-9">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询车系信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
								...
								<fieldset>
									<section>
										<label class="input"> <i
											class="icon-append fa fa-question-circle"></i> <input
											type="text" class="form-control" placeholder="系列名称"
											id="seriesName" name="seriesNameLike" /> <b
											class="tooltip tooltip-top-right">需要输入系列名称</b>
										</label>
									</section>
								</fieldset>
	...
	<script src="${ctx}/js/platform/business/carseries.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
