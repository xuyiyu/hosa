...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 优惠券管理 <span>> 优惠券记录 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="hidden-xs col-sm-4 col-md-2 col-lg-2 ">优惠券内容</th>
												<th class="hidden-xs hidden-sm col-md-4 col-lg-5">审核状态</th>
												<th class="hidden-xs col-sm-2 col-md-2 col-lg-2 sorting"
													paging-sort-column="type">优惠券按类型</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													...
													item-id="statusString">&nbsp;</td>
												<td class="hidden-xs col-sm-2 col-md-2 col-lg-2 view"
													item-id="typeString">&nbsp;</td>
												<td>
													<div class="btn-group  btn-group-justified">
														<a href="javascript:void(0);"
															class="btn btn-primary btn-xs " item-view item-id="button-view" style="display:none;">
															详情 </a>
														<a href="javascript:void(0);"
															class="btn btn-primary btn-xs " item-id="button-modify" style="display:none;">
			...
			<div class="modal-dialog" style="width: 700px;">
				<div class="modal-content">
								...
								<div class="row">
									...
									<section style="margin-left: 10px;margin-right: 14px;margin-bottom:0px;">
										...
										<div name="ticketCard" style="width: 100%;height: 170px;border: solid 1px;">
											<div class="row" >
												<div class="col col-12" style="margin-left:30px;"><label style="" name="nameView">100元优惠券</label></div>
											</div>
											<div class="row" >
												<div class="col col-12" style="margin-left:30px;">有效期：<label style="" name="validDaysString"></label></div>
											</div>
											<div class="row" style="margin-left:0px;margin-right:0px;margin-top: 50px;font-size: xx-large;">
												<div class="col col-12" style="padding-left: 40px;" name="couponValue">￥<label name="valueView">100</label></div>
												<div class="col col-12" style="padding-left: 40px;display:none;" name="couponPrize">礼品卷</div>
											</div>
										</div>
								...
								<section>
										<label class="select">
											<select style="width:100%"
														class="select2" id="createdDepartmentId" name="createdDepartmentId">
															<option></option>
													</select>
										</label>
									</section>
									...
									<section>
										<label class="select"> <div style="width:100%"
												class="select2" name="grantDepartmentNames"></div>
										</label>
									</section>
									<section>
									<label class="textarea">  										
										<textarea rows="5" id="settleAccountRules" name="settleAccountRules" placeholder="结算规则"></textarea> 
									</label>
								</section>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							item-id="button-save-submit">保存并提交审核</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询优惠券信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script src="${ctx}/js/platform/marketing/coupon.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
