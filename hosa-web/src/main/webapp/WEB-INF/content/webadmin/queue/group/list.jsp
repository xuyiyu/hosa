...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-tumblr fa-fw "></i> 业务群组<span>> 群组管理 </span>
				</h1>
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">设置群组信息</h4>
					</div>
							...
							<form id="edit-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										<div class="col-5 col">
											<h3>未选座席</h3>
          									<select id="waitSelect" name="waitSelect" multiple="multiple" style="width:100%;height:120px;"></select>
										</div>
										
										
									<div class="col-1 col" style="margin-left:25px;">
										<div class="row"><section></section></div>
										 <div class="row">
										 	<button name="addAllButton" type="button" class="btn btn-default" style="width: 30px;margin-top:15px;">
																&gt;&gt;
															</button>
										 </div>
										<div class="row">
										    <button name="addButton" type="button" class="btn btn-default" style="width: 30px;margin-top:5px;">
																&gt;
															</button>
										</div>
										<div class="row">
											   <button name="delAllButton" type="button" class="btn btn-default" style="width: 30px;margin-top:5px;">
																&lt;&lt;
															</button>
										</div>
										<div class="row">

											  <button name="delButton" type="button" class="btn btn-default" style="width: 30px;margin-top:5px;">
																&lt;
															</button>
										</div>
									</div>
									<div class="col-5 col">
										<h3>已选座席</h3>
          								<select id="hasSelect" name="hasSelect" multiple="multiple" style="width:100%;height:120px;"></select>
									</div>
									</div>
									</section>
								</fieldset>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">群组信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="view-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										...
										<section class="col col-9">
											<select id="hasSelect" name="hasSelect" multiple="multiple" style="width:100%;height:100%;" disabled></select>
										</section>
									</div>
								</fieldset>
							</form>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询群组信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
								...
								<fieldset>
									<section>
										<label class="input"> <i
											class="icon-append fa fa-question-circle"></i> <input
											type="text" class="form-control" placeholder="名称"
											id="categoryNameLike" name="categoryNameLike" /> <b
											class="tooltip tooltip-top-right">需要输入群组名称</b>
										</label>
									</section>
								</fieldset>
	...
	<script src="${ctx}/js/platform/queue/queue.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
