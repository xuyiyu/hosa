...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 商城管理  <span>> 商品分类管理 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="departmentId">隶属部门</th>
												<th class="col-xs-4 col-sm-4 col-md-2 col-lg-2 sorting"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">设置商品分类信息</h4>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">商品分类信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询商品分类信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
								...
								<fieldset>
									...
									<section>
										<label class="input"> <i
											...
											id="picStoragePath" name="picStoragePath" /> <b
	...
	<script src="${ctx}/js/platform/mall/goodscategory.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
