...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 群组管理<span>> 群组管理 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-12 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="name">群组名称</th>
												<th class="col-xs-12 col-sm-4 col-md-2 col-lg-2" sorting"
													paging-sort-column="count">用户数</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													class="hidden-xs col-sm-4 col-md-2 col-lg-2 filter_count view"
													item-id="count">&nbsp;</td>
												<td>
								...
								<fieldset>
									<section>
										<label class="input"> <i
											...
											type="text" class="form-control" placeholder="群组名称"
											id="name" name="name" /> <b
								...
								<fieldset>
								    <div class="row">
										...
										<section class="col col-9">
											<label class="" name='name' item-id="name"> </label>
										</section>
									</div>
								</fieldset>
							</form>
								...
								<fieldset>
									<section>
										<label class="input"> <i
											...
											class="tooltip tooltip-top-right">群组名称</b>
										</label>
									</section>
								</fieldset>
	...
	<script src="${ctx}/js/platform/weixingroup/weixingroup.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
