...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 组织管理 <span>> 角色管理 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-12 col-sm-12 col-md-4 col-lg-4 sorting"
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td class="col-xs-12 col-sm-12 col-md-4 col-lg-4 filter_name view"
													item-id="name" item-view>&nbsp;</td>
												<td class="hidden-xs hidden-sm col-md-8 col-lg-8 filter_description view"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">设置角色信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
							<form id="edit-form" class="smart-form">
									...
									<section>
										<label class="textarea"> <i
											class="icon-append fa fa-question-circle"></i> <textarea
												class="form-control" placeholder="描述" rows="5"
								...
								<fieldset>
									<section>
										<label class="label">拥有权限</label>
										<div class="row" id="authority-list">
											<div style="display:none;">
												<label class="checkbox" item-template> <input
													type="checkbox" name="authorityId"> <i></i></label>
											</div>
							...
							<form id="view-form" class="smart-form">
								...
								<fieldset>
									...
									<div class="row">
										...
										<section class="col col-9">
											<label class="" item-id="authority-list"> </label>
										</section>
									</div>
								</fieldset>
							</form>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询角色信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script src="${ctx}/js/platform/organization/role.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
