...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-group fa-fw "></i> 组织管理 <span>> 用户组管理 </span>
				</h1>
			</div>
									...
									<table id="data-table"
										...
										<thead>
											<tr paging-title>
												...
												<th class="col-xs-12 col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="name">用户组名称</th>
												<th class="hidden-xs col-sm-4 col-md-2 col-lg-2 sorting"
													paging-sort-column="parent_id">隶属用户组</th>
										...
										<tbody class="list">
											<tr style="display:none;" item-template>
												...
												<td
													class="hidden-xs col-sm-4 col-md-2 col-lg-2 filter_parentName view"
													item-id="parentDepartment.name">&nbsp;</td>
												<td
									...
									<div class="dt-bottom-row">
										<div class="row" >
											<div class="hidden-xs col-sm-5">
												<div class="dataTables_info" paging-summary> 共 <label
			paging-summary-record-total></label> 条</div>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">设置用户组信息</h4>
					</div>
								...
								<fieldset>
									...
									<section>
										<label class="input"> <i
											...
											id="name" name="name" /> <b
											class="tooltip tooltip-top-right">需要输入用户组名称</b>
										</label>
									</section>
									<section>
										<label class="textarea"> <i
											class="icon-append fa fa-question-circle"></i> <textarea
												class="form-control" placeholder="用户组描述" rows="5"
												id="description" name="description"></textarea> <b
											class="tooltip tooltip-top-right">需要输入用户组描述</b>
										</label>
									</section>
								</fieldset>
								<fieldset>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">用户组信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
								...
								<fieldset>
									<div class="row">
										<section class="col col-3">
											<label class="label" >隶属用户组:</label>
										</section>
										<section class="col col-9">
											<label class="" item-id="parentDepartment.name"> </label>
										</section>
									</div>
									<div class="row">
										<section class="col col-3">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">查询用户组信息</h4>
					</div>
					<div class="modal-body">
						<div class="widget-body no-padding">
	...
	<script src="${ctx}/js/platform/organization/department.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
