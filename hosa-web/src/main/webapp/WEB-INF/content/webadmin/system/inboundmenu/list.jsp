...
<body>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-comments fa-fw "></i> 系统管理 <span>> 自定应答菜单 </span>
				</h1>
			</div>
							...
							<form id="edit-form" class="smart-form">
								...
								<fieldset>
									...
									<section>
										...
										<select style="width:45%;margin-left:9%;"
														class="select2" id="keyword" name="keyword">
														<option></option>
									...
									<section class="material_section" style="">
									<label class="select">
	...
	<script src="${ctx}/js/platform/system/inboundmenu.js"></script>
	<script>
		$(function() {
			$("[rel=tooltip]").tooltip();
