$(function() {
	...
	var queryUrl = ctx + "/webadmin/websetting/model/model!list.htm";
	var getUrl = ctx + "/webadmin/websetting/model/model!input.htm";
	var saveUrl = ctx + "/webadmin/websetting/model/model!save.htm";
	var deleteUrl = ctx + "/webadmin/websetting/model/model!delete.htm";
	...
	var columns = [  "id" ,  "departmentId" ,  "name" ,  "modelLink" ,  "picUrl" ,  "modified"];	
	var searchColumns = [  "departmentId" ,  "nameLike" ,  "modelLink" ,  "picUrl" ,  "modified"];
	var filterColumns = [  "filter_departmentId" ,  "filter_name" ,  "filter_modelLink" ,  "filter_picUrl" ,  "filter_modified"];
	...
	var bindingSaveParam = function() {
		...
		param["model.picUrl"] = editForm.find('#picUrl').val();
		return param;
	}
