$(function() {
	...
	var queryUrl = ctx + "/webadmin/websetting/scheme/scheme!list.htm";
	var getUrl = ctx + "/webadmin/websetting/scheme/scheme!input.htm";
	var saveUrl = ctx + "/webadmin/websetting/scheme/scheme!save.htm";
	var deleteUrl = ctx + "/webadmin/websetting/scheme/scheme!delete.htm";
	...
	var columns = [  "id" ,  "departmentId" ,  "name" ,  "modelLink" ,  "status" ,  "createDate" ,  "modified"];	
	var searchColumns = [  "departmentId" ,  "name" ,  "modelLink" ,  "status" ,  "createDate" ,  "modified"];
	var filterColumns = [  "filter_departmentId" ,  "filter_name" ,  "filter_modelLink" ,  "filter_status" ,  "filter_createDate" ,  "filter_modified"];
