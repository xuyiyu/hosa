$(function() {
	...
	var queryUrl = ctx + "/webadmin/questionanswer/questionanswer/questionanswer!list.htm";
	var getUrl = ctx + "/webadmin/questionanswer/questionanswer/questionanswer!input.htm";
	var saveUrl = ctx + "/webadmin/questionanswer/questionanswer/questionanswer!save.htm";
	var deleteUrl = ctx + "/webadmin/questionanswer/questionanswer/questionanswer!delete.htm";
	
	var questionanswerMap = new HashMap();
	...
	var columns = [  "id" ,  "departmentId" ,  "question" ,  "answer" ,  "categoryId" ,  "modified"];	
	var searchColumns = [  "departmentId" ,  "question" ,  "answer" ,  "categoryId" ,  "modified"];
	var filterColumns = [  "filter_departmentId" ,  "filter_question" ,  "filter_answer" ,  "filter_categoryId" ,  "filter_modified"];
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var dept = questionanswerMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["questionanswer."+o+""] = val;
			} else {
				param["questionanswer."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["questionanswerQuery."+o+""] = val;
			} else {
				param["questionanswerQuery."+o+""] = "";
			}
		});
