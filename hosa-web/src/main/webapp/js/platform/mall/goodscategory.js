$(function() {
	...
	var queryUrl = ctx + "/webadmin/mall/goodscategory/goods-category!list.htm";
	var getUrl = ctx + "/webadmin/mall/goodscategory/goods-category!input.htm";
	var saveUrl = ctx + "/webadmin/mall/goodscategory/goods-category!save.htm";
	var deleteUrl = ctx + "/webadmin/mall/goodscategory/goods-category!delete.htm";
	
	var goodscategoryMap = new HashMap();
	...
	var columns = [  "id" ,  "name" ,  "departmentId" ,  "description" ,  "picUrl" ,  "picStoragePath" ,  "modified"];	
	var searchColumns = [  "name" ,  "departmentId" ,  "description" ,  "picUrl" ,  "picStoragePath" ,  "modified"];
	var filterColumns = [  "filter_name" ,  "filter_departmentId" ,  "filter_description" ,  "filter_picUrl" ,  "filter_picStoragePath" ,  "filter_modified"];
	...
	var loadList = function(p) {	
		...
		$.webAjax(queryUrl, param, function(responseData) {		
			...
			if(responseData.r_code == 0) {
				...
				if(data) {
					goodscategoryMap = new HashMap();
					$.each(data.result, function(i, o){
						goodscategoryMap.put(o.id, o);
	...
	var viewItem = function(tr) {	
		...
		var param = {};
		var dept = goodscategoryMap.get(itemId);
	...
	var bindingSaveParam = function() {
		...
		$.each(columns, function(i, o) {
			...
			if(val) {
				param["goodsCategory."+o+""] = val;
			} else {
				param["goodsCategory."+o+""] = "";
			}
		});
	...
	var bindingSearchParam = function() {
		...
		$.each(searchColumns, function(i, o) {
			...
			if(val) {
				param["goodscategoryQuery."+o+""] = val;
			} else {
				param["goodscategoryQuery."+o+""] = "";
			}
		});
