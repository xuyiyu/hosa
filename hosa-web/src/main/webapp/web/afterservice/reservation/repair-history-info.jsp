...
<div class="top-block block-select">预约维修
<p>为了给您更好的服务请您仔细阅读详细信息</p>
</div>
<div class="top-block block-select">您的预约信息：</div>
<div class="top-block block-select"> 客户姓名：${repariOrder.baideliUser.name }</div>
<div class="top-block block-select"> 联系电话：${repariOrder.baideliUser.mobile }</div>
<div class="top-block block-select"> 业务单号：${repariOrder.code }</div>
<div class="top-block block-select"> 预约时间：${repariOrder.appointmentTimeString }</div>
<div class="top-block block-select"> 车牌照号：${repariOrder.baideliUser.plate}</div>
<div class="top-block block-select"> 车架号：${repariOrder.baideliUser.frameNo}</div>
<div class="top-block block-select" id="statusShow"> 状态：</div>
<div id="status" style="display:none;">${repariOrder.status }</div>
