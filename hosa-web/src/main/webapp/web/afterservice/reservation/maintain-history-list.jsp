...
<script type="text/javascript">
	...
	var loadOrderDayList = function(){
		...
		$.webAjax(ctx+"/web/afterservice/reservation/maintain/maintain!loadOrderDayList.htm", param, function(responseData) {
				...
				if(data){
					...
					$.each(data,function(i,o){
						...
						_div.appendTo($("#orderDayList")).click(function(){
										...
										window.location.href = ctx + "/web/afterservice/reservation/maintain/maintain/historyorderinfo.htm?date="+date;
									});
