...
<section class="mc-by" id="info">
	...
	<div class="top-block item-title" id="maintainHistory">爱车保养历史</div>
...
<script type="text/javascript">
	...
	var loadOrderDaysInfo = function(){
		var param = {};
		param["nexts"] = nexts;
		$.webAjax(ctx+"/web/afterservice/reservation/maintain/maintain!loadOrderDaysInfo.htm", param, function(responseData) {
	...
	var save = function(){
		...
		$("form").attr("action",ctx + "/web/afterservice/reservation/maintain/maintain/save.htm").attr("method","post").submit();
	...
	$().ready(function() {
		...
		$("#maintainHistory").click(function(){
