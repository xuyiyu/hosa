...
<script type="text/javascript">
	...
	var loadOrderDayList = function(){
		...
		$.webAjax(ctx+"/web/afterservice/rescue/rescue/rescue!loadOrderDayList.htm", param, function(responseData) {
				...
				if(data){
					...
					$.each(data,function(i,o){
						...
						_div.appendTo($("#orderDayList")).click(function(){
										...
										window.location.href = ctx + "/web/afterservice/rescue/rescue/rescue/historyorderinfo.htm?date="+date;
									});
