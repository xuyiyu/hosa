...
<div class="top-block block-select">
<p style="font-weight:bold;">24小时救援</p>
<p>为了给您更好的服务请您仔细阅读详细信息</p>
</div>
<div class="top-block block-select">您的预约信息：</div>
<div class="top-block block-select"> 客户姓名：${rescueOrder.baideliUser.name }</div>
<div class="top-block block-select"> 联系电话：${rescueOrder.baideliUser.mobile }</div>
<div class="top-block block-select"> 业务单号：${rescueOrder.code }</div>
<div class="top-block block-select"> 预约时间：${rescueOrder.appointmentTimeString }</div>
<div class="top-block block-select"> 车牌照号：${rescueOrder.baideliUser.plate}</div>
<div class="top-block block-select"> 车架号：${rescueOrder.baideliUser.frameNo}</div>
<div class="top-block block-select"> 地理位置：${rescueOrder.location}</div>
<div class="top-block block-select" id="statusShow"> 状态：</div>
<div id="status" style="display:none;">${rescueOrder.status }</div>
